     ...
     Route::domain($current_hostname->fqdn)->group(function () {
          Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
               ...
               Route::prefix('reports')->group(function () {
                    ...
                    Route::get('sales-products', 'ReportProductsController@index')
                         ->name('tenant_reports_products_sales_day');
                    Route::post('sales-products', 'ReportProductsController@searchProducts')
                         ->name('tenant_reports_products_sales_day_search');
                    Route::get('sales-products_export/{type}/{name?}/{fs?}/{fe?}', 'ReportProductsController@exportProducts')
                         ->name('tenant_reports_products_sales_day_export');
